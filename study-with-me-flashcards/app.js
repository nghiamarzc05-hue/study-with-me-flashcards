...
$("#btnDownloadSample").addEventListener("click", () => {
  const sample = `word,ipa,meaning,example,tag
book,/bʊk/,quyển sách,"I read a book.",noun
apple,/ˈæp.əl/,quả táo,"I eat an apple every day.",noun
"thank you",/ˈθæŋk juː/,cảm ơn,"Thank you for your help.",phrase
`;
